...
export const SCENARIOS: Scenario[] = [
  {
    ...
    emoji: '🚢',
    context:
      'Çin\'li tedarikçiniz 500.000 TL değerinde elektronik malı teslim etmedi. Mahkeme süreci 3-5 yıl sürebilir, enflasyon alacağınızı eritiyor. Smart contract ile oracle doğrulaması kullanılsaydı ne fark ederdi?',
    learningGoal:
      'Fırsatçı karşı taraflarda oracle korumalı smart contract\'ın mahkeme sürecine kıyasla gerçek maliyet farkını görün.',
  ...
  },
  {
    ...
    emoji: '💻',
    context:
      'Bir yazılım firması proje bedelini aldı ama kaynak kodu teslim etmedi. Klasik sözleşmede ispat yükü size ait; arbitraj seçeneğiniz var. Smart contract\'ta milestonelar otomatik kilitlenebilirdi.',
    learningGoal:
      'Müteahhit tipli karşı taraflarda arbitraj vs. smart contract maliyet-zaman analizini karşılaştırın.',
  ...
  },
  {
    ...
    learningGoal:
      'Dürüst ama sözleşme ihlali yapan karşı taraflarda gecikme cezası mekanizmasını ve smart contract avantajını anlayın.',
